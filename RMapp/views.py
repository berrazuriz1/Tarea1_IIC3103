...
def episodes(term):
    episodesMatch = requests.get('https://integracion-rick-morty-api.herokuapp.com/api//episode/?name=' + term).json()
...
def lugares(term):
    locationsMatch = requests.get('https://integracion-rick-morty-api.herokuapp.com/api//location/?name=' + term).json()
...
def caracteres(term):
    charactersMatch = requests.get('https://integracion-rick-morty-api.herokuapp.com/api//character/?name=' + term).json()
...
def home(request):
    r = requests.get("https://integracion-rick-morty-api.herokuapp.com/api//episode").json()
    episodios = r['results']
...
def episode_view(request, id_episodio):
    r = requests.get("https://integracion-rick-morty-api.herokuapp.com/api//episode/" + str(id_episodio)).json()
    characters = []
...
def character_view(request, id_character):
    r = requests.get("https://integracion-rick-morty-api.herokuapp.com/api//character/" + str(id_character)).json()
    episodes= []
...
def location_view(request, id_lugar):
    r = requests.get("https://integracion-rick-morty-api.herokuapp.com/api//location/" + str(id_lugar)).json()
    characters = []
